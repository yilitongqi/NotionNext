...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '古字点', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '求索为真相，真理和自由！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://f.yilitongqi002.dpdns.org/', // 网站地址
